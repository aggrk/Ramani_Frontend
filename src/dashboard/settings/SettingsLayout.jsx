...
export default function SettingsLayout() {
  ...
  const linkClasses = ({ isActive }) =>
    `hover:text-primary hover:underline ${
      isActive ? "text-primary font-semibold underline" : "text-textlight"
    }`;
  ...
  return (
    <div className="mx-auto min-h-screen max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="mt-8 flex min-h-screen w-full gap-x-12">
        <div
          className={`flex h-full w-full flex-col py-2 md:w-1/4 md:border-r-2 ${
        ...
        >
          <div className="border-b-2 border-textdark/10 pb-2 pt-6">
            <button
              ...
              className="flex w-full items-center justify-between text-textlight hover:text-primary hover:underline"
            >
        ...
        >
          {!showSidebar && (
            <button
              ...
              className="mb-4 inline-block text-primary underline md:hidden"
            >
